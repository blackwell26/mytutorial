package com.blackwell.mytutorial.auth.security;
...
/**
 * Authenticates requests reaching auth-service.
 *
 ...
 *    (e.g. dev/testing tools hitting port 8081 directly). The JWT is validated
...
public class JwtAuthFilter extends OncePerRequestFilter {
     ...
     * Used when auth-service is called directly (bypassing the gateway).
     */
